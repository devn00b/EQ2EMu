...
function waypoints(NPC)
	MoveToLocation(NPC, 178.1, -3.31, 165.11, 2)
	MoveToLocation(NPC, 151.53, -2.98, 169.3, 2)
	MoveToLocation(NPC, 148.43, -3.5, 170.45, 2)
	MoveToLocation(NPC, 82.44, -4.34, 180.06, 2)

...
function waypoints(NPC)
	MoveToLocation(NPC, 181.1, -3.8, 177.94, 2)
	MoveToLocation(NPC, 133.92, -3.43, 179.71, 2)
	MoveToLocation(NPC, 124.06, -3.74, 179.89, 2)
	MoveToLocation(NPC, 118.85, -3.8, 179.04, 2)
	MoveToLocation(NPC, 103.77, -4, 180.18, 2)
	MoveToLocation(NPC, 99.86, -4, 180.98, 2)
	MoveToLocation(NPC, 93.8, -4.19, 181.4, 2)
	MoveToLocation(NPC, 91.38, -4.29, 181.01, 2)
	MoveToLocation(NPC, 87.87, -4.36, 181.06, 2)
	MoveToLocation(NPC, 83.06, -4.34, 180.1, 2)

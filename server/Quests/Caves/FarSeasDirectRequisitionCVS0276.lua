...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "Gather white spiderling chitin.", 10, 100, "I must hunt down the creatures in the Caves to fill the requisition.", 11, WHITE_SPIDERLING_ID)
...
function Step1Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 2, "Gather white spider silk.", 6, 25, "I must hunt down the creatures in the Caves to fill the requisition.", 11, WHITE_SPIDER_ID, WHITE_SPIDERLING_ID, ALBINO_ARACHNID)
